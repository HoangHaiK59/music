      ...
      <div className="container-fluid h-100 position-relative">
        ...
        <div style={{position: 'absolute', top: '40%', width: '100%', height: '50%', left: '45%'}}>
          <a
            ...
            href={`https://accounts.spotify.com/login?continue=https%3A%2F%2Faccounts.spotify.com%2Fauthorize%3Fscope%3D${scopes.join('%20')}%26response_type%3Dtoken%26redirect_uri%3Dhttp%253A%252F%252Flocalhost%253A3000%252Fhome%26state%3D34fFs29kd09%26client_id%3D7f9cbbd68daf4d19a8890769e24edd46%26show_dialog%3Dtrue`}
          >
            LOGIN WITH SPOTIFY
          </a>
        </div>
